...
from ...models import ControlNetSDVModel
from ...models import UNetSpatioTemporalConditionControlNetModel
...
class GaudiStableVideoDiffusionPipelineControlNet(GaudiStableVideoDiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        pipe = GaudiStableVideoDiffusionPipelineControlNet.from_pretrained(
        ...
        with torch.autocast(device_type="hpu", dtype=torch.bfloat16, enabled=self.gaudi_config.use_torch_autocast):
            ...
            self.controlnet.to(device, dtype=torch.bfloat16)
            ...
            controlnet_condition = self.video_processor.preprocess(controlnet_condition, height=height, width=width)
